...
contract SimpleVesting {
    ...
    function depositTokens(address recipient, uint256 amount) public timestampIsSet incomingDepositsStillAllowed {
    ...
    function claimTimeLockedTokensAfterTimePeriod(IERC20 token, address to, uint256 amount) public timestampIsSet noReentrant {
